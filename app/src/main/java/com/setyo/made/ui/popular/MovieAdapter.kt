...
import com.setyo.made.databinding.ItemListMovieBinding

class MovieAdapter(private val onItemClick: (MovieData) -> Unit) : ListAdapter<MovieData, MovieAdapter.ViewHolder>
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder  {
        ...
        val binding = ItemListMovieBinding.bind(views)
